...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default="cxrbiobert")
...
def make(config):
    ...
    cxr_bert_model = BertModel.from_pretrained("dmis-lab/biobert-base-cased-v1.1")
    cxr_bert_tokenizer = BertTokenizer.from_pretrained("dmis-lab/biobert-base-cased-v1.1")
    ...
    print('moco_biobert_wrapper loaded')
